...
/// Representa un paquete PINGREQ de MQTT. El ciente le envía una solicitud de PING al servidor.
...
impl Pingreq {
    ...
    /// Convierte un stream de bytes en un Pingreq.
    ...
    /// Convierte el Pingreq en un vector de bytes.
