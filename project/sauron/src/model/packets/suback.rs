...
use crate::{errors::error::Error, model::{fixed_header::FixedHeader, return_code::SubackReturnCode}};
...
impl Suback {
    ...
    pub fn from_bytes(fixed_header: FixedHeader, stream: &mut dyn Read) -> Result<Self, Error> {
        ...
        let packet_identifier = u16::from_be_bytes([variable_header_buffer[0], variable_header_buffer[1]]);
