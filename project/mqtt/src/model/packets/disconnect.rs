...
/// Representa un paquete DISCONNECT de MQTT. El cliente lo utiliza para desconectarse del servidor.
...
impl Disconnect {
    ...
    /// Convierte un stream de bytes en un Disconnect.
    ...
    /// Convierte el Disconnect en un vector de bytes.
